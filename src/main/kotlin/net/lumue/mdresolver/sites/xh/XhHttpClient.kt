...
import net.lumue.mdresolver.sites.addHeaders
import net.lumue.mdresolver.sites.names
...
private val xhLoginRequestHeaders: Map<String, String> = mapOf(
    ...
    "referer" to "https://www.xhamster.com/"
)
...
fun String.withGenericXhamsterDomain(): String {
